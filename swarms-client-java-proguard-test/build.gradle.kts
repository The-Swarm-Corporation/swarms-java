...
dependencies {
    testImplementation(project(":swarms-client-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../swarms-client-java-core/src/main/resources/META-INF/proguard/swarms-client-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.swarms.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../swarms-client-java-core/src/main/resources/META-INF/proguard/swarms-client-java-core.pro",
