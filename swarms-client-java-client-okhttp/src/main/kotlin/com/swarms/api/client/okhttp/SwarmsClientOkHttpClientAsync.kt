...
import com.swarms.api.client.SwarmsClientClientAsyncImpl
...
class SwarmsClientOkHttpClientAsync private constructor() {
    ...
    /** A builder for [SwarmsClientOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SwarmsClientClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SwarmsClientClientAsync =
            SwarmsClientClientAsyncImpl(
                clientOptions
                    .httpClient(
