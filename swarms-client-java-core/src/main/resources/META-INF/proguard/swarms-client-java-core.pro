...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.swarms.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.swarms.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.swarms.api.** {
    <init>(...);
