...
class BatchCreateCompletionResponse
...
private constructor(
     ...
     * ```java
     * MyClass myObject = batchCreateCompletionResponse.outputs().convert(MyClass.class);
     * ```
     */
    ...
    /** A builder for [BatchCreateCompletionResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchCreateCompletionResponse: BatchCreateCompletionResponse) = apply {
            id = batchCreateCompletionResponse.id
            charactersPerSource = batchCreateCompletionResponse.charactersPerSource
            description = batchCreateCompletionResponse.description
            name = batchCreateCompletionResponse.name
            outputs = batchCreateCompletionResponse.outputs
            sources = batchCreateCompletionResponse.sources
            timestamp = batchCreateCompletionResponse.timestamp
            usage = batchCreateCompletionResponse.usage
            additionalProperties = batchCreateCompletionResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchCreateCompletionResponse].
         *
         ...
         */
        fun build(): BatchCreateCompletionResponse =
            BatchCreateCompletionResponse(
                checkRequired("id", id),
    ...
    fun validate(): BatchCreateCompletionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchCreateCompletionResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "BatchCreateCompletionResponse{id=$id, charactersPerSource=$charactersPerSource, description=$description, name=$name, outputs=$outputs, sources=$sources, timestamp=$timestamp, usage=$usage, additionalProperties=$additionalProperties}"
}
