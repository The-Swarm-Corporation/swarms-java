...
class GraphWorkflowExecuteWorkflowResponse
...
private constructor(
    ...
    ) : this(jobId, outputs, status, timestamp, usage, description, name, mutableMapOf())
    ...
    /** A builder for [GraphWorkflowExecuteWorkflowResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            jobId = graphWorkflowExecuteWorkflowResponse.jobId
            outputs = graphWorkflowExecuteWorkflowResponse.outputs
            status = graphWorkflowExecuteWorkflowResponse.status
            timestamp = graphWorkflowExecuteWorkflowResponse.timestamp
            usage = graphWorkflowExecuteWorkflowResponse.usage
            description = graphWorkflowExecuteWorkflowResponse.description
            name = graphWorkflowExecuteWorkflowResponse.name
            additionalProperties =
                graphWorkflowExecuteWorkflowResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GraphWorkflowExecuteWorkflowResponse].
         *
         ...
         */
        fun build(): GraphWorkflowExecuteWorkflowResponse =
            GraphWorkflowExecuteWorkflowResponse(
    ...
    fun validate(): GraphWorkflowExecuteWorkflowResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GraphWorkflowExecuteWorkflowResponse &&
            jobId == other.jobId &&
    ...
    override fun toString() =
        "GraphWorkflowExecuteWorkflowResponse{jobId=$jobId, outputs=$outputs, status=$status, timestamp=$timestamp, usage=$usage, description=$description, name=$name, additionalProperties=$additionalProperties}"
}
