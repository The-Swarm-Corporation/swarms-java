...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): AgentListResponse = AgentListResponse(additionalProperties.toImmutable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentListResponse && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "AgentListResponse{additionalProperties=$additionalProperties}"
}
