...
private constructor(
    private val body: List<SwarmSpec>,
    private val additionalHeaders: Headers,
    private val additionalQueryParams: QueryParams,
) : Params {

    fun body(): List<SwarmSpec> = body
    ...
    class Builder internal constructor() {
        ...
        private var body: MutableList<SwarmSpec>? = null
        ...
        fun body(body: List<SwarmSpec>) = apply { this.body = body.toMutableList() }

        /**
         * Adds a single [SwarmSpec] to [Builder.body].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addBody(body: SwarmSpec) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchRunParams &&
            body == other.body &&
