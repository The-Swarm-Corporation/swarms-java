...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SwarmGetLogsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SwarmGetLogsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SwarmGetLogsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(swarmGetLogsParams: SwarmGetLogsParams) = apply {
            additionalHeaders = swarmGetLogsParams.additionalHeaders.toBuilder()
            additionalQueryParams = swarmGetLogsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SwarmGetLogsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SwarmGetLogsParams =
            SwarmGetLogsParams(additionalHeaders.build(), additionalQueryParams.build())
    }
