...
class MarketplaceCreateAgentResponse
...
private constructor(
    ...
    /** A builder for [MarketplaceCreateAgentResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(marketplaceCreateAgentResponse: MarketplaceCreateAgentResponse) = apply {
            prompts = marketplaceCreateAgentResponse.prompts.map { it.toMutableList() }
            totalCount = marketplaceCreateAgentResponse.totalCount
            status = marketplaceCreateAgentResponse.status
            timestamp = marketplaceCreateAgentResponse.timestamp
            additionalProperties =
                marketplaceCreateAgentResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MarketplaceCreateAgentResponse].
         *
         ...
         */
        fun build(): MarketplaceCreateAgentResponse =
            MarketplaceCreateAgentResponse(
    ...
    fun validate(): MarketplaceCreateAgentResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketplaceCreateAgentResponse &&
    ...
    override fun toString() =
        "MarketplaceCreateAgentResponse{prompts=$prompts, totalCount=$totalCount, status=$status, timestamp=$timestamp, additionalProperties=$additionalProperties}"
}
