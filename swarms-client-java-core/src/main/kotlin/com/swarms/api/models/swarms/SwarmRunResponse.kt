...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): SwarmRunResponse = SwarmRunResponse(additionalProperties.toImmutable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SwarmRunResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "SwarmRunResponse{additionalProperties=$additionalProperties}"
}
