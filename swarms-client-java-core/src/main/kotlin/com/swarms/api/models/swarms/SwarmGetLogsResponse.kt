...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): SwarmGetLogsResponse = SwarmGetLogsResponse(additionalProperties.toImmutable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SwarmGetLogsResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "SwarmGetLogsResponse{additionalProperties=$additionalProperties}"
}
